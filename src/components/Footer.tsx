...
const Footer = () => {
  return (
    <footer className="bg-tutor-darkpurple text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-2xl mb-4 gradient-text">TutorMatch</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">support@tutormatch.com</li>
              <li className="text-gray-300">+1 (555) 123-4567</li>
              <li className="text-gray-300">123 Learning Street<br />Education City, EC 12345</li>
            </ul>
          </div>
        </div>
